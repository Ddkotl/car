...
CREATE TABLE "car_marks" (
    ...
    CONSTRAINT "car_marks_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "car_marks_name_key" ON "car_marks"("name");

-- CreateIndex
CREATE UNIQUE INDEX "car_marks_slug_key" ON "car_marks"("slug");
...
-- AddForeignKey
ALTER TABLE "cars_models" ADD CONSTRAINT "cars_models_carMarksId_fkey" FOREIGN KEY ("carMarksId") REFERENCES "car_marks"("id") ON DELETE SET NULL ON UPDATE CASCADE;
