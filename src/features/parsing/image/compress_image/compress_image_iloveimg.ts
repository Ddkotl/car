...
export const compressImageILoveImage = async (imageBuffer: Buffer, page: Page): Promise<Buffer> => {
  try {
    ...
    await page.goto("https://www.iloveimg.com/compress-image", { timeout: 60000, waitUntil: "domcontentloaded" });
    ...
    await page.waitForSelector("div[class='tool__workarea__rendered']", {
      timeout: 60000,
    });
